...
import { restaurantThemeV2, hotelTheme, comingSoonTheme, supermarketTheme, parkTheme, subwayTheme, homeTheme, citywalkTheme } from '../data';
...
export const useGameStore = create<GameStore>()(
  persist(
    (set, get) => ({
      ...initialState,
      // 所有主题列表
      themes: [restaurantThemeV2, hotelTheme, supermarketTheme, parkTheme, subwayTheme, homeTheme, citywalkTheme, comingSoonTheme],
      ...
      setTheme: (theme: Theme) => {
        ...
        // 使用新版 level1 界面的主题
        const newThemeIds = ['restaurant_v2', 'hotel', 'driving', 'supermarket', 'park', 'subway', 'home', 'citywalk'];
      ...
      isThemeUnlocked: (themeId: string) => {
        const state = get();
        // 新主题默认解锁
        const newThemes = ['restaurant_v2', 'hotel', 'driving', 'supermarket', 'park', 'subway', 'home', 'citywalk'];
